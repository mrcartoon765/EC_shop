...
class pay_end{
	//ログインしている場合の購入の処理
	public static function login_pay_end($mail,$zip1,$zip2,$address,$tel1,$tel2,$tel3,$total,$customer_id,$family_name,$first_name,$products){
	$dbh = database::dbh();
$stmt1 = $dbh->prepare("INSERT INTO orders(mail, zip1, zip2, address, tel1, tel2, tel3, total, customer_id, family_name, first_name, created_at, updated_at) VALUES(:mail, :zip1, :zip2, :address, :tel1, :tel2, :tel3, :total, :customer_id, :family_name, :first_name, now(), now())");
...
$stmt2->execute();
	...
	//ログインしていない場合の購入の処理
	public static function no_login_pay_end($mail,$zip1,$zip2,$address,$tel1,$tel2,$tel3,$total,$family_name,$first_name,$products
	){
		$dbh = database::dbh();
	$stmt1 = $dbh->prepare("INSERT INTO orders(mail, zip1, zip2, address, tel1, tel2, tel3, total, customer_id, family_name, first_name, created_at, updated_at) VALUES(:mail, :zip1, :zip2, :address, :tel1, :tel2, :tel3, :total, :customer_id,  :family_name, :first_name, now(), now())");
