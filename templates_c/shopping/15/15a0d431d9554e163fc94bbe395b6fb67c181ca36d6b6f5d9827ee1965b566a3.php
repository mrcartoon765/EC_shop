...
\t\t\t\t\t\t<h5>";
            // line 17
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["value"], "title", [], "any", false, false, false, 17), "html", null, true);
            echo "</h5>
...
\t\t\t\t\t\t<p>価格　￥";
            // line 19
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["value"], "price", [], "any", false, false, false, 19), "html", null, true);
            echo "</p>
...
\t\t\t\t\t\t<p>";
            // line 21
            echo twig_escape_filter($this->env, twig_slice($this->env, twig_get_attribute($this->env, $this->source, $context["value"], "detail", [], "any", false, false, false, 21), 0, 40), "html", null, true);
            echo "...</p>
\t\t\t\t\t\t<div class=\"item-form\">
...
\t</div>
    ...
    {
        return array (  95 => 30,  80 => 21,  76 => 20,  72 => 19,  68 => 18,  64 => 17,  58 => 15,  54 => 13,  50 => 12,  37 => 1,);
    }
