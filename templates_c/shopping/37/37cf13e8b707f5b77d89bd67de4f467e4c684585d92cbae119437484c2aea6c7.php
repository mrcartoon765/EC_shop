...
class __TwigTemplate_e9f286ec4cd4e7cc25948eb00b02149a5e71a7cade2d33b9fda47f976a0c4b1d extends \Twig\Template
{
   ...
   <form class=\"pay-form\"  action=\"../../shopping/pay_card.php\" method=\"POST\">
       ...
       <div class=\"form-group\">
           ...
           <input type=\"text\" name=\"tel1\" size=\"6\" maxlength=\"6\" required  value=";
        // line 30
        echo twig_escape_filter($this->env, ($context["tel1"] ?? null), "html", null, true);
        echo ">
           -<input type=\"text\" name=\"tel2\" size=\"6\" maxlength=\"6\" required value=";
        // line 31
        echo twig_escape_filter($this->env, ($context["tel2"] ?? null), "html", null, true);
        echo ">
           -<input type=\"text\" name=\"tel3\" size=\"6\" maxlength=\"6\" required value=";
        // line 32
       ...
       <div class=\"form-group\">
           ...
           <label>〒</label>
           <div class=\"form-group\" style=\"display:inline-flex\">
           <input type=\"text\" name=\"zip1\" required value=";
        // line 38
        echo twig_escape_filter($this->env, ($context["zip1"] ?? null), "html", null, true);
        echo ">-
           <input type=\"text\" name=\"zip2\" required value=";
        // line 39
 ...
 ";
    ...
    {
        return array (  120 => 50,  109 => 42,  103 => 39,  99 => 38,  90 => 32,  86 => 31,  82 => 30,  74 => 25,  67 => 21,  63 => 20,  46 => 6,  40 => 2,  37 => 1,);
    }
