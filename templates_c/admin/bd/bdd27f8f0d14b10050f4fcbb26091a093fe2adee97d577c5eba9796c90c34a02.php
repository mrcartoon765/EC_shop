...
\t\t\t\t<a href=\"";
        ...
        echo "news/news.php\" class=\"box col-6 col-md-3 border border-2 border-info\">
\t\t\t\t\t<br>
...
\t\t\t\t<a href=\"";
        // line 14
        echo twig_escape_filter($this->env, ($context["admin"] ?? null), "html", null, true);
        echo "user/users.php\" class=\"box col-6 col-md-3 border border-2 border-info\">
\t\t\t\t\t<br>
...
\t\t\t\t<a href=\"";
        // line 19
        echo twig_escape_filter($this->env, ($context["admin"] ?? null), "html", null, true);
        echo "order/orders.php\" class=\"box col-6 col-md-3 border border-2 border-info\">
\t\t\t\t\t<br>
...
\t\t\t\t<a href=\"";
        // line 24
        echo twig_escape_filter($this->env, ($context["admin"] ?? null), "html", null, true);
        echo "book/books.php\" class=\"box col-6 col-md-3 border border-2 border-info\">
\t\t\t\t\t<br>
...
\t\t\t\t<a href=\"";
        // line 29
        echo twig_escape_filter($this->env, ($context["admin"] ?? null), "html", null, true);
        echo "sub/secondary_products.php\" class=\"box col-6 col-md-3 border border-2 border-info\">
\t\t\t\t\t<br>
