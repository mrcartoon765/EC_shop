...
<body>
    ...
    <main>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["value"]) {
            ...
            echo "</td>
                                <td>";
            // line 52
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["value"], "first_name", [], "any", false, false, false, 52), "html", null, true);
            echo "</td>
                                <td>";
            // line 53
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["value"], "mail", [], "any", false, false, false, 53), "html", null, true);
            echo "</td>
                                <td>";
            // line 54
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["value"], "dm", [], "any", false, false, false, 54), "html", null, true);
            echo "</td>
                                <td>
            ...
            echo "'\">編集</button>
                                    <button type=\"button\" class=\"btn btn-red delete\" data-id='{ attribute(value,'id') }}' >削除</button>
   ...
   <script>
    ...
    {
        return array (  138 => 64,  127 => 59,  121 => 58,  114 => 56,  109 => 54,  105 => 53,  101 => 52,  97 => 51,  94 => 50,  90 => 49,  54 => 16,  37 => 1,);
    }
